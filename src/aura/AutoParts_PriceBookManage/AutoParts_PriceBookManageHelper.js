...
({
    ...
    doGetAllCategories: function(component, event) {
        let action = component.get("c.getAllCategories");
    ...
    doAddNewDiscount: function(component, typeDiscount, discount, category) {
        let priceBookId = component.get("v.recordId");
        let doAddNewDiscountAction = component.get("c.doAddNewDiscountCallout");
        ...
        doAddNewDiscountAction.setParam("priceBookId", priceBookId);
        doAddNewDiscountAction.setCallback(this, function(response) {
             let state = response.getState();
             if (state === "SUCCESS") {
                 let doAddNewDiscountEvent = $A.get("e.c:AutoParts_PriceBookRefreshEvent");
